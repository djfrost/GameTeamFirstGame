...
#define FirstGame_Source_FirstGame_MainCharacter_h_12_RPC_WRAPPERS \
 \
	DECLARE_FUNCTION(execInteractRaycast) \
	{ \
		P_FINISH; \
		P_NATIVE_BEGIN; \
		this->InteractRaycast(); \
		P_NATIVE_END; \
	} \
 \
	DECLARE_FUNCTION(execChangeMode) \
	{ \
		P_GET_UBOOL(Z_Param_Mode); \
		P_FINISH; \
		P_NATIVE_BEGIN; \
		this->ChangeMode(Z_Param_Mode); \
		P_NATIVE_END; \
	}
...
#define FirstGame_Source_FirstGame_MainCharacter_h_12_PRIVATE_PROPERTY_OFFSET \
	...
	FORCEINLINE static uint32 __PPO__InteractRange() { return STRUCT_OFFSET(AMainCharacter, InteractRange); }


#define FirstGame_Source_FirstGame_MainCharacter_h_10_PROLOG
